...
namespace ValiVisionV2.iOS.VideoFrameAnalyzer
{
    ...
    {
        private static readonly SemaphoreSlim s_printMutex = new SemaphoreSlim(1);
        private static readonly BlockingCollection<string> s_messageQueue = new BlockingCollection<string>();
